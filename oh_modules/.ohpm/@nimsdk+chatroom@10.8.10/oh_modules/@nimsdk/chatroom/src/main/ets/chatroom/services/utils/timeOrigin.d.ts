import { Logger, PromiseManager } from '@nimsdk/base';
...
export default class TimeOrigin {
    ...
    timer: number;
    cmdName: string;
    constructor(q46: V2NIMChatroomClient, r46?: Partial<TimeOriginConfig>, s46?: string);
    setOptions(p46: Partial<TimeOriginConfig>): void;
    reset(): void;
     ...
     */
    getNTPTime(c46?: TimeNode): number;
    /**
     * 校验时间节点的偏移是否可信,
     *
     ...
     *       time1               time2
     */
    checkNodeReliable(z45: TimeNode): boolean;
