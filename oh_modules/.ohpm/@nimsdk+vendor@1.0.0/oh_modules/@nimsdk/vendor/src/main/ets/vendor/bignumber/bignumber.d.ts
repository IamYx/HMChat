...
export declare class BigNumber implements BigNumber.Instance {
  ...
  /** The coefficient of the value of this BigNumber, an array of base 1e14 integer numbers, or null. */
  public readonly c: number[] | null;

  /** The exponent of the value of this BigNumber, an integer number, -1000000000 to 1000000000, or null. */
  public readonly e: number | null;

  /** The sign of the value of this BigNumber, -1, 1, or null. */
  public readonly s: number | null;
   ...
   */
  public constructor(n: BigNumber.Value, base?: number);
  ...
  public decimalPlaces(decimalPlaces: number, roundingMode?: BigNumber.RoundingMode): BigNumber;
  ...
  public dp(decimalPlaces: number, roundingMode?: BigNumber.RoundingMode): BigNumber;
   ...
   * @param [base] The base of n.
   */
  public idiv(n: BigNumber.Value, base?: number): BigNumber;
   ...
   * @param [m] The modulus.
   */
  public exponentiatedBy(n: BigNumber.Value, m?: BigNumber.Value): BigNumber;
  public exponentiatedBy(n: number, m?: BigNumber.Value): BigNumber;
   ...
   * @param [m] The modulus.
   */
  public pow(n: BigNumber.Value, m?: BigNumber.Value): BigNumber;
   ...
   * @param [base] The base of n.
   */
  public isLessThanOrEqualTo(n: BigNumber.Value, base?: number): boolean;
   ...
   * @param [base] The base of n.
   */
  public modulo(n: BigNumber.Value, base?: number): BigNumber;
   ...
   * @param [base] The base of n.
   */
  public mod(n: BigNumber.Value, base?: number): BigNumber;
   ...
   */
  public precision(includeZeros?: boolean): number;
   ...
   * @param [roundingMode] Rounding mode, integer, 0 to 8.
   */
  public precision(significantDigits: number, roundingMode?: BigNumber.RoundingMode): BigNumber;
   ...
   * @param [includeZeros] Whether to include integer trailing zeros in the significant digit count.
   */
  public sd(includeZeros?: boolean): number;
   ...
   * @param [roundingMode] Rounding mode, integer, 0 to 8.
   */
  public sd(significantDigits: number, roundingMode?: BigNumber.RoundingMode): BigNumber;
   ...
   * @param [roundingMode] Rounding mode, integer, 0 to 8.
   */
  public toExponential(decimalPlaces: number, roundingMode?: BigNumber.RoundingMode): string;
   ...
   */
  public toFraction(max_denominator?: BigNumber.Value): [BigNumber, BigNumber];
   ...
   * @param [roundingMode] Rounding mode, integer 0 to 8.
   */
  public toPrecision(significantDigits: number, roundingMode?: BigNumber.RoundingMode): string;
  ...
  public static readonly ROUND_UP: 0;

  /** Rounds towards zero. */
  public static readonly ROUND_DOWN: 1;

  /** Rounds towards Infinity. */
  public static readonly ROUND_CEIL: 2;

  /** Rounds towards -Infinity. */
  public static readonly ROUND_FLOOR: 3;

  /** Rounds towards nearest neighbour. If equidistant, rounds away from zero . */
  public static readonly ROUND_HALF_UP: 4;

  /** Rounds towards nearest neighbour. If equidistant, rounds towards zero. */
  public static readonly ROUND_HALF_DOWN: 5;

  /** Rounds towards nearest neighbour. If equidistant, rounds towards even neighbour. */
  public static readonly ROUND_HALF_EVEN: 6;

  /** Rounds towards nearest neighbour. If equidistant, rounds towards Infinity. */
  public static readonly ROUND_HALF_CEIL: 7;

  /** Rounds towards nearest neighbour. If equidistant, rounds towards -Infinity. */
  public static readonly ROUND_HALF_FLOOR: 8;

  /** See `MODULO_MODE`. */
  public static readonly EUCLID: 9;
   ...
   */
  public static clone(object?: BigNumber.Config): BigNumber.Constructor;
   ...
   * @param object The configuration object.
   */
  public static config(object?: BigNumber.Config): BigNumber.Config;
   ...
   * @param n A numeric value.
   */
  public static maximum(...n: BigNumber.Value[]): BigNumber;
   ...
   * @param n A numeric value.
   */
  public static max(...n: BigNumber.Value[]): BigNumber;
   ...
   * @param n A numeric value.
   */
  public static minimum(...n: BigNumber.Value[]): BigNumber;
   ...
   * @param n A numeric value.
   */
  public static min(...n: BigNumber.Value[]): BigNumber;
   ...
   * @param [decimalPlaces] Decimal places, integer, 0 to 1e+9.
   */
  public static random(decimalPlaces?: number): BigNumber;
   ...
   * @param n A numeric value.
   */
  public static sum(...n: BigNumber.Value[]): BigNumber;
   ...
   * @param object The configuration object.
   */
  public static set(object?: BigNumber.Config): BigNumber.Config;
}
